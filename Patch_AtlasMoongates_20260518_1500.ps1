# Patch_AtlasMoongates_20260518_1500.ps1
# Fixes three expansion moongate coordinates in WorldAtlas.cs
# Run from VS Code terminal: .\Patch_AtlasMoongates_20260518_1500.ps1
...
if ($changes -eq 0) {
    Write-Host 'WARNING: No matching lines found - already patched?' -ForegroundColor Yellow
    exit 0
}
